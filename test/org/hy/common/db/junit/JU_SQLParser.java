...
public class JU_SQLParser 
{
	...
	public static void verify()
	{
		...
		{
			System.out.println($KEYS_PATTERN.get(i));
		}
	}
	...
	public void hy(String i_SQLText)
	{
		...
		while ( v_Matcher.find() )
		{
			...
			// System.out.println(v_SQLText.substring(v_MatcheEndIndex ,v_StartIndex));
		...
		{
			// System.out.println(v_SQLText.substring(v_MatcheEndIndex));
		}
	...
	{
		System.out.println(this.sqlFrame);
		...
		for (int i=this.sqlUnitList.size()-1; i>=0; i--)
		{
			...
			for (int x=0; x<v_SQLUnit.getSQLSegments().size(); x++)
			{
				...
				{
					System.out.println(v_Spaces + v_Segment.getSQLSegment());
				}
				else
				{
					System.out.println(v_Spaces + StringHelp.rpad(" " ,v_Segment.getStartPosition() ," ") + v_Segment.getSQLSegment());
				}
			}
		}
	}
	...
	public static void main(String [] args)
	{
		...
		System.out.println(v_JU_SQLParser.hy_Union());
