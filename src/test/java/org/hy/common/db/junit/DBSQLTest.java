...
{
    private static final Logger $Logger = new Logger(DBSQLTest.class ,true);
    ...
    public static void main(String [] args)
    {
        ...
        $Logger.info(v_DBSQL.getSQL(v_Test ,null));
        $Logger.info(v_DBSQL.getSQLType());
        ...
        $Logger.info("无填充项的情况：" + v_DBSQL.getSQL());
    }
